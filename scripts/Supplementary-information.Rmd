...
d.order %<>%
  ...
  droplevels()
```
We recruited a total of 69 additional participants in the single and multi-talker conditions for which we wanted to compare the effect of exposure variability. None of the participants met any of the exclusion criteria.

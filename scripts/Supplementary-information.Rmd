...
print(hypothesis(m.exp1a.subjective_similarity.ST.sentence_level, "Similarity > 0"))
print(hypothesis(m.exp1b.subjective_similarity.ST.sentence_level, "Similarity > 0"))
```

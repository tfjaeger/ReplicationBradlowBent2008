...
add_individual_performance = . %>%
  ...
  # set to * 0.6365345 if coef from training is to be considered)
...
table_3effects(m.exp1a.test.diff.wExposureTestTalker, 
               scope = "coef", group = "ExposureTestTalkerID")
table_3effects(m.exp1a.test.diff.wExposureTestTalker, 
               scope = "ranef", group = "ExposureTestTalkerID")
```
...
m.exp1ab.noAdditionalPredictors.test.diff <- brm(IsCorrect ~ Cond.diff + offset(individual_training_performance.offset) + 
                           (1 + Cond.diff | Sentence) + (1 | WorkerID),  

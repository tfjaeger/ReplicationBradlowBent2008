...
# offset model
m.exp1a.test.treat <- brm(IsCorrect ~ Cond.treat + offset(individual_training_performance.offset) +
                            (1 + Cond.treat | Sentence) + (1 | WorkerID),
                          data = d.exp1a.test, family = bernoulli, cores = max.cores, chains = max.cores,
                          warmup = nsamples.warmup, iter = nsamples.total,
                          prior = my.priors, file = "../models/exp1a.Test.treat")
...
```{r, replication analysis with sliding difference coding, message=F, warning=F}
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Step 2: Run model on original data. But with numerically coded variables instead of contrast
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
m.exp1a.test.diff <- brm(IsCorrect ~ offset(individual_training_performance.offset) + 
...
# Step 4: Run same numerically-coded model on new data, but with priors based on original data  
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
m.exp1b.test.diff.full <- brm(IsCorrect ~ offset(individual_training_performance.offset) + 
                                Cond.diffTS.vs.MT + Cond.diffMT.vs.ST + Cond.diffST.vs.CNTL + 
                                (1 + Cond.diffTS.vs.MT + Cond.diffMT.vs.ST + Cond.diffST.vs.CNTL | Sentence) + 
                                (1 | WorkerID),  
                              data = d.exp1b.test, family = bernoulli, 
...
# Step 5: Run the bridge sampler on all new models fit to the replication data
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
filename.b1 = "../models/bridge_exp1b.Test.diff.numerical_coded_conditions.rds"
filename.b2.a = "../models/bridge_exp1b.Test.diff.woTS.vs.MT.numerical_coded_conditions.rds"
filename.b2.b = "../models/bridge_exp1b.Test.diff.woMT.vs.ST.numerical_coded_conditions.rds"
filename.b2.c = "../models/bridge_exp1b.Test.diff.woST.vs.CNTL.numerical_coded_conditions.rds"
...
if (!file.exists(filename.b2.a)) {
  ...
  saveRDS(b2.woTS.vs.MT, file = filename.b2.a)
} else {
  b2.woTS.vs.MT = readRDS(file = filename.b2.a)
}

if (!file.exists(filename.b2.b)) {
  b2.woMT.vs.ST = bridge_sampler(
    samples = m.exp1b.test.diff.woMT.vs.ST, cores = 8, method = "warp3", maxiter = 1000)
  saveRDS(b2.woMT.vs.ST, file = filename.b2.b)
} else {
  b2.woMT.vs.ST = readRDS(file = filename.b2.b)
}

...
plot_3effects(m.exp1b.test.diff.wTestTalker, "Experiment 1b by test talker", 
              by = "TestTalker", fill = colors.model[2], alpha = 1)
ggsave(filename = "../figures/exp1b_Q123_effects_byTestTalker.pdf", width = 12, height = 3.5)
...
Total number of models that needed to be fit: `r rbind(d.sim, d.sim.small, d.sim.half, d.sim.2var) %>%
  mutate_at(vars(Final.treat, Final.diff),
            .funs = function(x) as.numeric(factor(x, 
